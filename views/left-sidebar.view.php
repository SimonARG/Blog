<div class="sidebar sd-left flex-c f-al-cent">
    ...
    <a class="sb-links fill-width flex-r f-al-cent f-just-cent" href="http://localhost/Blog/single.php?id=20">Sobre Mi</a>

    <a class="sb-links fill-width flex-r f-al-cent f-just-cent" href="http://localhost/Blog/single.php?id=21/">Sobre Este Blog</a>
</div>